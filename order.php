									...
									<div class="d-flex flex-column flex-xl-row">
										<div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
											<div class="mt-n1">
												<div class="d-flex flex-stack pb-10">
													<a href="#">
														<img alt="Logo" src="https://media.discordapp.net/attachments/895295408413216778/926188594169786398/ALL_SERVICE.png">
													</a>
												...
												<div class="m-0">
													...
													<div class="row g-5 mb-12">
														...
														<div class="col-sm-6">
															...
															<div class="fw-bolder fs-6 text-gray-800">ALL Service</div>
														</div>
														<!--end::Col-->
													</div>
													<!--end::Row-->
										...
										<div class="m-0">
											<div class="d-print-none border border-dashed border-gray-300 card-rounded h-lg-100 min-w-md-350px p-9 bg-lighten">
												...
												<div class="mb-6">
													<div class="fw-bold text-gray-600 fs-7">Minecraft Launcher</div>
													<p> <a href="https://launcher.mojang.com/download/MinecraftInstaller.exe" class="link-primary">Download(Windows 10/11)</a></div>
													<a href="https://launcher.mojang.com/download/MinecraftInstaller.msi" class="link-primary">Download(Windows 7/8)</a></div>
													<a href="https://launcher.mojang.com/download/Minecraft.dmg" class="link-primary">Download(Mac)</a></div>
													</p>
												</div>
											</div>
										</div>
